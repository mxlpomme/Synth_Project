...
class SineWaveGenerator:
    ...
    def __init__(self, pitch=0, decibels=1, decibels_per_second=1, samplerate=default_sample_rate):
        ...
        self.output_stream = sd.OutputStream(channels=1,callback= lambda *args: self._callback(*args), samplerate=samplerate)
    ...
    def new_frequency_array(self, time_array):
        ...
        new_frequency = self.frequency * interval_to_frequency_ratio(dir * self.pitch_per_second * time_array)
    ...
    def new_amplitude_array(self, time_array):
        ...
        new_amplitude = self.amplitude * decibels_to_amplitude_ratio(dir * self.decibels_per_second * time_array)
